            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Account Payables</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item">
                            <span class="bullet bg-gray-500 w-5px h-2px"></span>
                            ...
                            <form class="w-[60%]">
                                <div class="row">
                                    <div class="col-md-6">
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div class="position-relative mb-3">
                                                    <input class="form-control form-control-md form-control-solid"
                                                        type="text" name="customer" id="customer" value="{{$payable->supplier_name}}" readonly/>
                                                    <input class="form-control form-control-md form-control-solid"
                                                        type="hidden" name="payable_id" id="payable-id" value="{{$payable->id}}"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="fv-row mb-5">
                                            <div class="mb-1">
                                                <label class="form-label fw-bold fs-6 mb-2">Nomor PO</label>
                                                <div class="position-relative mb-3">
                                                    <input class="form-control form-control-md form-control-solid" type="text" name="transaction_no" id="transaction-no" value="{{$payable->purchase_order_no}}" readonly/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="separator my-5"></div>
                                        <div class="fv-row mb-5">
                                            <div class="mb-1">
                                                <label class="form-label fw-bold fs-6 mb-2">Tanggal PO</label>
                                                <div class="position-relative mb-3">
                                                    <input class="form-control form-control-md form-control-solid"
                                                        type="date" name="invoice_date" id="transaction-date" value="{{$payable->purchase_order_date}}" readonly/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="separator my-5"></div>
                                        <div class="fv-row mb-5">
                                            <div class="mb-1">
                                                ...
                                                <div class="position-relative mb-3">
                                                    <input class="form-control form-control-md form-control-solid"
                                                        type="date" name="due_date" id="due-date" value="{{$payable->due_date}}" readonly/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="separator my-5"></div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="fv-row mb-5">
                                            <div class="mb-1">
                                                <label class="form-label fw-bold fs-6 mb-2">Total Hutang</label>
                                                <div class="position-relative mb-3">
                                                    <input class="form-control form-control-md form-control-solid"
                                                        type="text" name="total_amount" id="total-amount" value="{{$payable->total_amount}}" readonly/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="separator my-5"></div>
                                        <div class="fv-row mb-5">
                                            <div class="mb-1">
                                                <label class="form-label fw-bold fs-6 mb-2">Sisa Hutang</label>
                                                <div class="position-relative mb-3">
                                                    <input class="form-control form-control-md form-control-solid"
                                                        type="text" name="total_amount" id="total-amount" value="{{$payable->remaining_balance}}" readonly/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="separator my-5"></div>
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div class="position-relative mb-3">
                                                    <select class="form-select form-select-solid" data-control="select2"
                                                        ...
                                                        <option value="">-</option>
                                                        <option value="paid" <?php echo ($payable->status == 'paid') ? 'selected' : '';?>>PAID</option>
                                                        <option value="unpaid" <?php echo ($payable->status == 'unpaid') ? 'selected' : '';?>>UNPAID</option>
                                                        <option value="partial" <?php echo ($payable->status == 'partial') ? 'selected' : '';?>>PARTIAL / TERM</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="text-end">
                                    <a href="{{route('finances.account-payable.index')}}"
    ...
    if (true) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: `{{route('finances.account-payable.save-payments')}}`,
                    type: 'POST',
                    headers: {
                    ...
                    success: function(response) {
                        Swal.fire({
                            ...
                            location.href =
                                `{{ route('finances.account-payable.index') }}`;
                        });
                    },
