                                ...
                                <div class="col-md-6">
                                    <div class="fv-row mb-5">
                                        <div class="mb-1">
                                            ...
                                            <div class="position-relative mb-3">
                                                <select class="form-select form-select-solid" data-control="select2" data-placeholder="-" name="category" id="category">
                                                    <option value="">-</option>
                                    ...
                                    <div class="text-end">
                                        ...
                                        <a href="#" class="btn btn-sm btn-primary" id="btn-submit-request">Update Request</a>
                                    </div>
                                </div>
                            </div>
                        </div>
