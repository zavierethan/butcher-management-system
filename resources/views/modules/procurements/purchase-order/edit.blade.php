                                ...
                                <div class="col-md-6">
                                    <div class="fv-row mb-5">
                                        <div class="mb-1">
                                            ...
                                            <div class="position-relative mb-3">
                                                <input class="form-control form-control-md form-control-solid"
                                                    type="text" name="total_amount" id="total-amount" value="{{$purchaseOrder->total_amount}}" readonly/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="separator my-5"></div>
                                        ...
                                        <div class="mb-1">
                                            ...
                                            <div class="position-relative mb-3">
                                                <select class="form-select form-select-solid" data-control="select2" data-placeholder="-" name="status" id="status">
                                                    ...
                                                    <option value="completed" <?php echo ($purchaseOrder->status == 'completed') ? 'selected' : ''; ?>>COMPLETED</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-end">
                                        ...
                                        <a href="#" class="btn btn-sm btn-primary" id="btn-submit-request">Update PO</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_items_table">
                                ...
                                <tbody class="fw-bold text-gray-600">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">@php echo number_format($item->total, 0, '.', ',') @endphp</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                                <!--end::Table body-->
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        Swal.fire({
                            title: 'Suceess !',
                            text: `Transaksi berhasil di simpan dengan Nomor PO ${response.order_number}`,
                            icon: 'success',
