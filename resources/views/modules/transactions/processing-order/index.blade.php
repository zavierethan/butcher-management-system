            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
                        Processing Orders</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="index.html" class="text-muted text-hover-primary">Processing Orders</a>
                        </li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Processing Orders</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{ route('processing-orders.create') }}" class="btn btn-sm fw-bold btn-secondary" id="btn-form-export">Export ke Excel</a>
...
$(document).ready(function() {
    ...
    const table = $("#kt_transactions_table").DataTable({
        ...
        ajax: {
            url: `{{route('processing-orders.get-lists')}}`, // Replace with your route
            type: 'GET',
            data: function (d) {
                ...
                render: function(data, type, row) {
                    return `
                        <div class="text-center">
                            <a href="/processing-orders/edit/${row.id}" class="btn btn-sm btn-light btn-active-light-primary" title="Detail Transaksi"><i class="fa-solid fa-magnifying-glass"></i></a>
                        <div>
                    `;
                }
            }
