                        ...
                        <div class="card-body pt-10">
                            <div class="row">
                                <div class="fv-row mb-5">
                                    <div class="mb-1">
                                        <label class="form-label fw-bold fs-6 mb-2">Nama Store</label>
                                ...
                                <div class="fv-row mb-5">
                                    <div class="mb-1">
                                        <label class="form-label fw-bold fs-6 mb-2">Tanggal SO</label>
                                        <div class="position-relative mb-3">
                                ...
                                <div class="separator my-5"></div>
                                <div class="text-end">
                                    <a href="{{ route('stocks.index') }}" class="btn btn-sm fw-bold btn-danger">Back</a>
                                    <a href="#" class="btn btn-sm fw-bold btn-primary" id="btn-usubmit-so">Submit Hasil
                                        SO</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_products_table">
                                ...
                                <tbody class="fw-bold text-gray-600" id="product-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control form-control-sm closing-stock-quantity"
                                                value="0" />
                                        </td>
                                        @endforeach
                                </tbody>
...
$(document).on('click', '#btn-usubmit-so', function(e) {
    e.preventDefault();
