                ...
                <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pt-0 overflow-x-auto">
                            <!--begin::Table-->
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_inventories_table">
                                <!--begin::Table head-->
                                <thead>
                                    <!--begin::Table row-->
                                    <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Tanggal Update Terakhir</th>
...
<script>
    ...
    $("#kt_inventories_table").DataTable({
        processing: true,
        serverSide: true,
        paging: true, // Enable pagination
        pageLength: 10, // Number of rows per page
        ajax: {
            url: `{{route('inventory-details.get-lists')}}`, // Replace with your route
            type: 'GET',
        ...
        columns: [
            {
                data: null,
                name: 'inventory_code_name',
                render: function (data, type, row) {
                    return `${row.inventory_code} - ${row.inventory_name}`;
                }
            },
            {
                data: null,
                ...
                render: function (data, type, row) {
                    return `
                        <div class="text-center">
                            <a href="/inventory-detail-logs/${row.id}" class="btn btn-sm btn-light btn-active-light-primary">Details</a>
                        <div>
                    `;
                }
            }
