                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="fv-row mb-5">
                                            <div class="mb-1">
                                                <label class="form-label fw-bold fs-6 mb-2">Payment Code</label>
                                                <div class="position-relative mb-3">
                                                    <input class="form-control form-control-md form-control-solid"
                                                        type="text" name="payment_code" id="payment-code" value="{{$payment->payment_code}}"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="fv-row mb-5">
                                            <div class="mb-1">
                                                ...
                                                <div class="position-relative mb-3">
                                                    <input class="form-control form-control-md form-control-solid"
                                                        type="text" name="invoice_no" id="invoice-no" value="{{$payment->invoice_no}}"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="separator my-5"></div>
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div class="position-relative mb-3">
                                                    <select class="form-select form-select-solid" data-control="select2"
                                                        ...
                                                        <option value="">-</option>
                                                        <option value="1" {{ $payment->payment_method == 1 ? 'selected' : '' }}>TUNAI</option>
                                                        <option value="2" {{ $payment->payment_method == 2 ? 'selected' : '' }}>TRANSFER</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div class="position-relative mb-3">
                                                    <input class="form-control form-control-md form-control-solid format-number"
                                                        type="text" name="total_amount" id="total-amount" value="{{ number_format($payment->amount, 0, '.', ',') }}"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="separator my-5"></div>
