                            ...
                            <form class="w-[60%]" method="POST" action="{{route('customers.update')}}">
                                ...
                                <div class="fv-row mb-5">
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <textarea class="form-control form-control-md form-control-solid" type="text" name="transaction_notes" id="transaction_notes">{{$customer->transaction_notes}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="separator my-5"></div>
