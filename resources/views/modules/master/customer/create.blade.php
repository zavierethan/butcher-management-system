                ...
                <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                    <div class="card">
                        <div class="card-body pt-10">
                            <form class="w-[60%]" method="POST" action="{{route('customers.save')}}">
                                @csrf
                                ...
                                <div class="fv-row mb-5">
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <input class="form-control form-control-md form-control-solid" type="text" name="ktp_number" id="ktp_number" />
                                        </div>
                                    </div>
                                </div>
                                <div class="separator my-5"></div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <select class="form-select form-select-solid" data-control="select2" data-placeholder="-" name="type">
                                                ...
                                                <option value="Perusahaan/Kolektif">Perusahaan / Kolektif</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="fv-row mb-5">
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <textarea class="form-control form-control-md form-control-solid" type="text" name="address" id="address"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="separator my-5"></div>
