...
<script>
    $("#kt_product_categories_table").DataTable({
        ...
        ajax: {
            url: `{{route('product-categories.get-lists')}}`, // Replace with your route
            type: 'GET',
                ...
                render: function (data, type, row) {
                    return `
                        <div class="text-center">
                            <a href="/product-categories/edit/${row.id}" class="btn btn-sm btn-light btn-active-light-primary">Edit</a>
                        <div>
                    `;
                }
            }
