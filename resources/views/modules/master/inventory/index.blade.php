        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="d-flex align-items-center gap-2 gap-lg-3">
                    ...
                    <a href="{{route('inventories.create')}}" class="btn btn-sm fw-bold btn-primary">New</a>
                    <!--end::Primary button-->
                </div>
                <!--end::Actions-->
            </div>
...
<script>
    $("#kt_inventories_table").DataTable({
        ...
        ajax: {
            url: `{{route('inventories.get-lists')}}`, // Replace with your route
            type: 'GET',
                ...
                render: function (data, type, row) {
                    return `
                        <div class="text-center">
                            <a href="/inventories/edit/${row.id}" class="btn btn-sm btn-light btn-active-light-primary">Edit</a>
                        <div>
                    `;
                }
            }
