                            ...
                            <form class="w-[60%]" method="POST" action="{{route('branches.update')}}">
                                ...
                                <div class="fv-row mb-5">
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <input class="form-control form-control-md form-control-solid" type="text" name="name" id="name" value="{{$branch->name}}" />
                                        </div>
                                    </div>
                                </div>
                                <div class="separator my-5"></div>
                                <div class="fv-row mb-5">
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <input class="form-control form-control-md form-control-solid" type="text" name="address" id="address" value="{{$branch->address}}" />
                                        </div>
                                    </div>
                                </div>
                                <div class="separator my-5"></div>
                                <div class="fv-row mb-5">
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <input class="form-control form-control-md form-control-solid" type="text" name="phone_number" id="phone_number" value="{{$branch->phone_number}}" />
                                        </div>
                                    </div>
                                </div>
                                <div class="separator my-5"></div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative mb-3">
                                            <select class="form-select form-select-solid" data-control="select2" data-placeholder="-" name="is_active">
                                                <option value=""></option>
                                                <option value="1" <?php echo ($branch->is_active == 1) ? "selected" : ""; ?>>Yes</option>
                                                <option value="0" <?php echo ($branch->is_active == 0) ? "selected" : ""; ?>>No</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
